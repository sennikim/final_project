...
@st.cache_data
def load_data():
    pantone  = pd.read_csv("data/pantone_color_of_year.csv")
    fashion  = pd.read_csv("data/fashion_color_trends.csv")
    social   = pd.read_csv("data/social_media_color_trends.csv")
    film     = pd.read_csv("data/film_color_palettes.csv")
    pop      = pd.read_csv("data/color_family_popularity.csv")
